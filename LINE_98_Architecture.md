...
| **Camera** | `CameraRig` + `CameraProfileSO` (fov ≈28, tiltX ≈58°, small yaw, distance, padding, parallax); `BoardFitSolver` projects the 4 board corners and iterates distance until 9×9 fits 9:16 → 9:22. Procedural, not authored per device. |
